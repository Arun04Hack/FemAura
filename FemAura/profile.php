  ...
  <div class="card">
    ...
    <!-- <h2><?php echo $name; ?></h2> -->
     <div class="Info">
        ...
        <h2>Name: Valarmathy </h2>
        <h2>Age:48</h2>
        <h2>Weight: 70 Kg </h2>
        <h2>Height: 5.2 ft</h2>
        <h2>Marital status: Yes </h2>
        <h2>Health Problems: Diabetes Type II</h2>
        <h2>Medicine Consumed: Yes, Doctors Prescribed </h2>
        <p class="title">Teacher</p>
        <p>Email- valarsec@gmail.com</p>
    </div>
